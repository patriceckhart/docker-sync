...
log_heading "Starting docker-sync"
...
if [ -z "${SYNC_MAX_INOTIFY_WATCHES}" ]; then
  ...
  # If docker-sync runs with this environment variable set, we'll try to set the config
...
echo "
# This file is automatically generated by docker-sync. Do not modify.
